...
class Reserva extends Component
{
    public $horaInicio, $horaFin, $flgNuevaReserva, $firstDayMonth, $lastDayMonth, $cantDaysMonth, $fechaSolicitud,
        ...
        $diasRestantesMesActual, $fechaActual, $fechaSiguiente, $fechaUltima, $diasMesesAnt, $correoUser, 
        $codEstado, $codEstadoOrig, $descripcionEstado,
    ...
    public function mount()
    {
        ...
        // $response = Http::get('http://appl.smc.cl/ws/wsJsonRRHH/colaboradores/detalle.ashx', [
        //     'rut' => '14029163',
        //     'COMUNA' => 'GOB_REG_BIO-BIO',
        // ]);

        // $jsonResponse = json_decode($response->body(), true/* true para Array Asociativo */);

        // dd($jsonResponse, $jsonResponse['nombre']);

        //Liquidaciones
        // $response = Http::get('http://appl.smc.cl/ws/wsJsonRRHH/usuario/liquidaciones/detalle.ashx', [
        //     'rut' => '14213732',
        //     'dominio_id' => 1,
        //     'anio' => 2022,
        //     'mes' => 11,
        ...
        // http://appl.smc.cl/ws/wsJsonRRHH/usuario/vacaciones/administrativos.ashx?rut=14629190&dominio_id=1&anio=2022&COMUNA=GOB_REG_BIO-BIO
    // $response = Http::get('http://appl.smc.cl/ws/wsJsonRRHH/usuario/vacaciones/administrativos.ashx', [
    //     'rut' => '14629190',
    //     'dominio_id' => 1,
    //     'anio' => 2022,
    //     'COMUNA' => 'GOB_REG_BIO-BIO',
