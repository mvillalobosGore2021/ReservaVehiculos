...
function dselect(el, option = {}) {
  ...
  //Inicio Agregado por MVillalobos 04-11-2022
  const placeHolderAttr = select_box_element.dataset.placeholder != null ? select_box_element.dataset.placeholder :"" ;
  
  const searchInput = search ? `<input onkeydown="return event.key !== 'Enter'" onkeyup="dselectSearch(event, this, '${classElement}', '${classToggler}', ${creatable})" type="text" class="form-control" placeholder="${placeHolderAttr}" autofocus>` : ""; 
    ...
    <div class="dropdown ${classElement} ${additionalClass}">
      ...
      <div class="dropdown-menu">
        <div class="d-flex flex-column">
          ...
          <div class="${classNoResults} d-none">No se encontraron resultados</div>
        </div>
      </div>
      ${clearBtn}
    </div>
