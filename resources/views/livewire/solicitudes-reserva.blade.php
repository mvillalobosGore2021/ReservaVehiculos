      ...
      <div class="table-responsive card mx-2 mt-4">
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr style="height:55px;cursor:pointer;" wire:click="reservaSel('{{$item->idReserva}}')" data-tippy-content="Click para editar">
              ...
              <div class="row">
                <div class="col-12 col-md-6 ps-4">
                  ...
                  <div class="row pt-3 pt-md-0 pb-3">
                    <div class="col-12">
                      <textarea wire:model.debounce.500ms="motivoSel" wire:loading.attr="disabled" wire:target="guardarReservaSel" placeholder="Motivo de la reserva (Máximo 500 caracteres)" class="form-control" maxlength="500" rows="3"></textarea>
                    </div>
                    @error('motivoSel')
                    <div class="col-12">
                      <span class="colorerror">{{$message}}</span>
                      ...
                      <thead>
                        <tr>
                          <th scope="col" colspan="4" class="text-center text-success pb-3">
                            Reservas realizadas para el día (Mostrar las del mismo dia)
                          </th>
                        </tr>
                        <tr>
